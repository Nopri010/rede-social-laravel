...
class HomeController extends Controller
{
    ...
    public function index()
    {
        ...
        $user = User::where('id',$user_id)->with('posts', 'posts.comments', 'posts.comments.user', 'posts.likes', 'posts.likes.user', 'posts.photos')->first();
        ...
        return view('home',['listaPosts' => $listaPosts ,'user' => $user]);
    }
}